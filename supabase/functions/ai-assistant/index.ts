...
Deno.serve(async (req: Request) => {
  ...
  try {
    ...
    if (
      ...
      lowerMsg.includes('electronics') ||
      lowerMsg.includes('eletrônicos')
    ) {
      ...
      lowerMsg.includes('mapear') ||
      lowerMsg.includes('importa') ||
      lowerMsg.includes('planilha') ||
      lowerMsg.includes('coluna')
    ) {
